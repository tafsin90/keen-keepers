  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-4 ">
        {friends.map((friend) => (
          <div key={friend.id} className="py-8 px-15 space-y-2 bg-white text-center rounded-lg shadow-sm">
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-1">
                {friend.tags.map((tag) => (
                  <div key={tag} className="badge bg-emerald-200 text-emerald-900 font-semibold p-3">
                    {tag}
                  </div>
                ))}
              </div>
